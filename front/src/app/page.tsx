          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <Card className="bg-zinc-200 p-6 text-center">
              <CardContent>
                ...
                <p className="text-muted-foreground">
                  Gérez facilement les adhésions, les statuts et les
                  informations de vos membres.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-zinc-200 p-6 text-center">
            ...
            <Card className="bg-zinc-200 p-6 text-center">
              <CardContent>
                ...
                <p className="text-muted-foreground">
                  Organisez et gérez vos assemblées générales en toute
                  simplicité.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-zinc-200 p-6 text-center">
              <CardContent>
                ...
                <p className="text-muted-foreground">
                  Stockez et partagez vos documents importants en toute
                  sécurité.
                </p>
              </CardContent>
            </Card>
